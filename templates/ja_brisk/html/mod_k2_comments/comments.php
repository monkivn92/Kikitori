...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?> <?php if($comment->userImage): ?>user-comment<?php endif; ?>">
			...
			<a class="lcComment" href="<?php echo $comment->link; ?>"><span class="lcComment"><?php echo $comment->commentText; ?></span></a>
			<?php else: ?>
			<span class="lcComment"><?php echo $comment->commentText; ?></span>
			<?php endif; ?>

			<?php if($params->get('commenterName')): ?>
			<span class="lcUsername"><strong>By</strong>
			...
			<span class="lcCommentDate">
				...
				<?php else: ?>
				  <strong><?php echo JText::_('K2_ON'); ?></strong> <?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_LC4')); ?>
				<?php endif; ?>
			</span>
			<?php endif; ?>
