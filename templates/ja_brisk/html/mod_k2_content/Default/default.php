    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="item-meta">
        ...
        <?php if($params->get('itemDateCreated')): ?>
          <span class="moduleItemDateCreated"> <strong>On </strong> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC4')); ?></span>
        <?php endif; ?>

        <?php if($params->get('itemCategory')): ?>
          <span><strong><?php echo JText::_('K2_IN') ; ?> </strong><a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a></span>
        <?php endif; ?>
      </div>
